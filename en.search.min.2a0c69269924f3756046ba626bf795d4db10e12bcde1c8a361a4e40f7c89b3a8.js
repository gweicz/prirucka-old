...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bb86fccb227e509b293082c8e51b6774282c695eed8e98b81a7fc83101583e26.js',function(){input.required=false;search();});}
