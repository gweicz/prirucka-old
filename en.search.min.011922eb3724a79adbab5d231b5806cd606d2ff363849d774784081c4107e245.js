...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dec7d581021cc26191612483623acf6de4a851800b362cc4cb6a32423a945685.js',function(){input.required=false;search();});}
