...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a14801dae83605193a1ae3a8ee8d42e9ae0824f3b08f4d9deea180671074aeae.js',function(){input.required=false;search();});}
