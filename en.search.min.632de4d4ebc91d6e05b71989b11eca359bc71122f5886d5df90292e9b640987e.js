...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.86d17c173433e7a47d272cb1ae65dd6d4221de3df56ba60bc75fe1cffc447713.js',function(){input.required=false;search();});}
